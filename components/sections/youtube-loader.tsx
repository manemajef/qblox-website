        ...
        <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-[1.5fr_1fr] gap-8 md:gap-12 items-center">
          ...
          <div className="text-center md:text-left space-y-4 md:space-y-6">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold text-white leading-tight">
              <AnimatedIn delay={0}>Introducing Qblox</AnimatedIn>
            </h1>
            <h2 className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl text-white/90 leading-relaxed">
              ...
              <AnimatedIn delay={1500}>.</AnimatedIn>
            </h2>
          </div>
